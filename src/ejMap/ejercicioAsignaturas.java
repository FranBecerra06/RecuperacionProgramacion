...
public class ejercicioAsignaturas {
    ...
    public static void main(String[] args) {
        ...
        // En "Programacion", el nombre "Ana" aparece dos veces, pero se tratará como único en la cuenta.
        asignaturas.put("Programacion", Arrays.asList("Ana", "Luis", "Carlos", "Ana"));
        ...
        // Iteramos sobre cada lista de estudiantes de cada asignatura.
        for (List<String> estudiantes : asignaturas.values()) {
            ...
            // Para cada estudiante único, incrementamos su contador en el mapa.
            for (String estudiante : estudiantesUnicos) {
                // Si el estudiante ya está en el mapa se incrementa su conteo; de lo contrario, se inicia en 0 y se suma 1.
