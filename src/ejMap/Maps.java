...
public class Maps {
    ...
    public static void main(String[] args) {
        ...
        // Añadimos productos y sus respectivos precios al HashMap.
        productos.put("Monitor", 100.3);
        productos.put("Teclado", 40.0);
        productos.put("Telefono", 300.0);
        productos.put("Ratón", 20.3);

        // Recorremos el HashMap y mostramos los productos (el orden es arbitrario).
        ...
        // Transferimos todos los productos del HashMap al TreeMap, aplicándose el orden definido.
